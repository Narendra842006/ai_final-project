...
SYMPTOMS = {
    ...
    'Tamil': [
        'காய்ச்சல்', 'இருமல்', 'மூச்சுத்திணறல்', 'நெஞ்சு வலி',
        'தலைவலி', 'சோர்வு', 'குமட்டல்', 'வாந்தி',
        'வயிற்றுப்போக்கு', 'வயிற்று வலி', 'தலைச்சுற்றல்', 'குழப்பம்',
        'வேகமான இதயத்துடிப்பு', 'பலவீனம்', 'பசியின்மை'
    ],
    'Telugu': [
        'జ్వరం', 'దగ్గు', 'ఊపిరి ఆడకపోవడం', 'ఛాతీ నొప్పి',
        'తలనొప్పి', 'అలసట', 'వాకరిక', 'వాంతులు',
        'విరేచనాలు', 'కడుపు నొప్పి', 'తలతిరగడం', 'గందరగోళం',
        'వేగవంతమైన గుండె కొట్టుకోవడం', 'బలహీనత', 'ఆకలి లేకపోవడం'
    ]
}
